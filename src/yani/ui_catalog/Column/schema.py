"""Column — the machine half of the contract. SKILL.md alongside carries the judgment half."""
...
class ColumnProps(BaseModel):
    children: list[str] = Field(description="ids of components already in this surface's list, top to bottom")
